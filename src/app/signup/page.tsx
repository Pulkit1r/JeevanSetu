...
import { EmailSignUp ,ScrollToTop, NumberSignUp , BottomGradient } from '@/components/index'
...
export default function Signup() {
 ...
 return <div className="shadow-input mx-auto my-10 w-full max-w-md rounded-none md:dark:shadow-gray-400 p-4 md:rounded-2xl md:p-8 ">
  <ScrollToTop />
      ...
      {type === "email"?<EmailSignUp />:<NumberSignUp />}
    <button
        ...
        >Signup with {type === "number"?"Email":"Phone Number"}
